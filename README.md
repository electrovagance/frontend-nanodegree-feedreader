...
# How to run
Clone the repo and open index.html to run!

`git clone https://github.com/electrovagance/frontend-nanodegree-feedreader`

# Used Dependencies
This project is using the following dependencies/apis:
- [Google Feed Read API](https://developers.google.com/feed/)
...
In order to pass this project, I was required to do the following:
